...
fixtures = [
        ...
        "filters": [
            [
                ...
                [
                    ...
                    "Normal Test Items-test_comment-in_list_view",
                    "Normal Test Items-test_comment-hidden",
        ...
        "filters": [
            [
                ...
                [
                    ...
                    "Special Test Template-is_subsection",
                ],
            ]
        ],
    },
    {"doctype": "Workflow", "filters": [["name", "in", ["Lab Test Workflow"]]]},
    {
    ...
    },
    {
        ...
        "filters": [["name", "in", ["Reject", "Submit", "Approve", "Cancel"]]],
    },
]
...
doctype_list_js = {"Lab Test": "public/js/cscripts/lab_test_list.js"}
...
doc_events = {
    "Lab Test Template": {
        ...
        "after_insert": "nd_customization.doc_events.lab_test_template.after_insert",
    ...
    "Lab Test": {
        ...
        "on_update_after_submit": "nd_customization.doc_events.lab_test.on_update_after_submit",
    },
    "Sales Invoice": {
...
override_whitelisted_methods = {
    "erpnext.healthcare.doctype.lab_test.lab_test.create_invoice": "nd_customization.api.lab_test.create_invoice"
}
